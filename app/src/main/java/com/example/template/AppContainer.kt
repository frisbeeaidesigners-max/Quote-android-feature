...
class AppContainer(context: Context) {
     ...
     * (inline overlay в Activity-окне) и MODAL_STICKY_2/MODAL_STICKY/MODAL_BUTTONS (Compose Dialog).
     ...
     * на STICKY-варианты пока влияет только через segmented control под меню (STICKY+ON);
     * для BUTTONS гейтит видимость стрелок-кнопок.
     */
